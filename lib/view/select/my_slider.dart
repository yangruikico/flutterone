...
/// A callback that formats a numeric value from a [MySlider] widget.
///
/// See also:
///
///  * [MySlider.semanticFormatterCallback], which shows an example use case.
...
class MySlider extends StatefulWidget {
  ...
  ///
  /// Ignored if this slider is created with [MySlider.adaptive].
  ///
  /// See also:
  ///
