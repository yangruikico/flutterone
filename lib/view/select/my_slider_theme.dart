...
/// [MySliderTheme.of]. When a widget uses [MySliderTheme.of], it is automatically
...
class MySliderTheme extends InheritedTheme {
  ...
  /// Returns the data from the closest [MySliderTheme] instance that encloses
  /// the given context.
  ///
  /// Defaults to the ambient [ThemeData.sliderTheme] if there is no
  /// [MySliderTheme] in the given build context.
  ///
  /// {@tool snippet}
  ///
  /// ```dart
  ...
  static SliderThemeData of(BuildContext context) {
    final MySliderTheme inheritedTheme = context.dependOnInheritedWidgetOfExactType<MySliderTheme>();
    return inheritedTheme != null ? inheritedTheme.data : Theme.of(context).sliderTheme;
  }

  @override
  Widget wrap(BuildContext context, Widget child) {
    final MySliderTheme ancestorTheme = context.findAncestorWidgetOfExactType<MySliderTheme>();
    return identical(this, ancestorTheme) ? child : MySliderTheme(data: data, child: child);
  }

  @override
  bool updateShouldNotify(MySliderTheme oldWidget) => data != oldWidget.data;
}
...
/// theme.
///
/// Use this class to configure a [MySliderTheme] widget, or to set the
/// [ThemeData.sliderTheme] for a [Theme] widget.
///
/// To obtain the current ambient slider theme, use [MySliderTheme.of].
///
...
/// See also:
///
///  * [MySliderTheme] widget, which can override the slider theme of its
///    children.
///  * [Theme] widget, which performs a similar function to [MySliderTheme],
...
class SliderThemeData with Diagnosticable {
  ...
  /// [copyWith] on the one you get from [MySliderTheme.of], or create an
...
///  * [MySliderTheme], which can be used to configure the tick mark shape of all
...
///  * [MySliderTheme], which can be used to configure the thumb shape of all
///    sliders in a widget subtree.
...
///  * [MySliderTheme], which can be used to configure the thumb shapes of all
...
///  * [MySliderTheme], which can be used to configure the overlay shape of all
///    sliders in a widget subtree.
...
///  * [MySliderTheme], which can be used to configure the slider value indicator
...
///  * [MySliderTheme], which can be used to configure the range slider value
