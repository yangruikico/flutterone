              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      SizedBox(width: 6,),
                      Image.asset("images/arrow_right_green.png", height: 24, width: 24,),
                      Image.asset("images/arrow_right_green.png", height: 16, width: 16,),
                      /// 因为向右箭头有透明边距导致两个箭头间隔过大，因此将第二个箭头向左偏移，如果切图无边距则不用偏移
                      Transform(
                        transform: Matrix4.translationValues(-8, 0, 0),
                        child: Image.asset("assets/images/arrow_right_green.png", height: 16, width: 16,),
                      ),
                    ],
                  ),
                ),
